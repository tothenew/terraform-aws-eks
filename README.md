...
| <a name="input_schedule_cron_start"></a> [schedule\_cron\_start](#input\_schedule\_cron\_start) | Cron expression to define when to trigger a start of the auto-scaling group for self-managed node group. E.g. '0 20 * * *' to start at 8pm GMT time. | `string` | `""` | no |
| <a name="input_schedule_cron_stop"></a> [schedule\_cron\_stop](#input\_schedule\_cron\_stop) | Cron expression to define when to trigger a stop of the auto-scaling group for self-managed node group. E.g. '0 10 * * *' to stop at 10am GMT time. | `string` | `""` | no |
